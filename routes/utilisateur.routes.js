...
utilisateurRouter.post('/', 
    ...
    /* #swagger.requestBody = { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/Utilisateur' } } } } */ 
    /* #swagger.responses[201] = { description: 'Utilisateur créé avec succès', schema: { $ref: '#/components/schemas/Utilisateur' } } */ 
...
utilisateurRouter.post('/signin', 
    ...
    /* #swagger.requestBody = { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/SignInBody' } } } } */ 
    /* #swagger.responses[201] = { description: 'Authentification réussie', schema: { $ref: '#/components/schemas/Utilisateur' } } */ 
